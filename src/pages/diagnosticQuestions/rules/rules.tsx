                  ...
                  <div className="row align-items-end">
                    <div className="col">
                      <ul className="question_heading">
                        ...
                        <li className="question_name">Professional Partner Recommendation</li>
                      </ul>
                    </div>
                    <div className="col-auto">
                      <ul className="question_options_area mt-0">
...
<button type="button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal12" >
  Launch demo modal
</button>



<div className="modal fade" id="exampleModal12" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="exampleModalLabel" aria-hidden="true">

  <div className="modal-dialog modal-dialog-centered">
    <div className="modal-content">
      <button type="button" className ="btn-close" data-bs-dismiss="modal" aria-label="Close"><svg width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="27" height="27" rx="13.5" fill="url(#paint0_linear_790_3208)"></rect><path fill-rule="evenodd" clip-rule="evenodd" d="M18.2908 18.2908C18.5697 18.0118 18.5697 17.5596 18.2908 17.2806L9.71936 8.70921C9.44042 8.43026 8.98816 8.43026 8.70921 8.70921C8.43026 8.98816 8.43026 9.44042 8.70921 9.71936L17.2806 18.2908C17.5596 18.5697 18.0118 18.5697 18.2908 18.2908Z" fill="#F4F4F4"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M8.70921 18.2908C8.98816 18.5697 9.44042 18.5697 9.71936 18.2908L18.2908 9.71936C18.5697 9.44042 18.5697 8.98815 18.2908 8.70921C18.0118 8.43026 17.5596 8.43026 17.2806 8.70921L8.70921 17.2806C8.43026 17.5596 8.43026 18.0118 8.70921 18.2908Z" fill="#F4F4F4"></path><defs><linearGradient id="paint0_linear_790_3208" x1="13.5" y1="0" x2="13.5" y2="27" gradientUnits="userSpaceOnUse"><stop stop-color="#E0B669"></stop><stop offset="1" stop-color="#B48A3E"></stop></linearGradient></defs></svg></button>
      <div className="modal-body">
        ...
        <div className="input_field">
          ...
          <div className="position-relative">
            <input id="email" placeholder="Enter Rule Name" className="form-control" autoComplete="off" type="email" name="email" />
          </div>
        </div>


        <div className="accordion accordion-flush" id="accordionCondition">
          <div className="accordion-item">
            ...
            <div id="flush-collapseOne" className="accordion-collapse collapse" data-bs-parent="#accordionCondition">
          ...
          <div className="accordion-item">
            ...
            <div id="flush-collapseTwo" className="accordion-collapse collapse" data-bs-parent="#accordionCondition">
              <div className="accordion-body">
                <select className="form-select" aria-label="Default select example">
                  <option selected>Select Question</option>
                  <option value="1">One</option>
                ...
                <a href="" className="add_more_value">+ Add More Values</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <button type="submit" className="btn common_button mt-3">Create Rule</button>
      </div>
    </div>
  </div>
</div>
