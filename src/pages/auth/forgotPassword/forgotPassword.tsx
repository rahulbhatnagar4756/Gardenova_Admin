...
export const ForgotPassword: React.FC = () => {
  ...
  const renderEmailStep = () => (
    <section className="bl_section">
      <div className="bf_wrapper">
        ...
        <h1 className="bl_head">Forgot Password</h1>
        <p className="bl_sub_head">
  ...
  const renderTokenStep = () => (
    <section className="bl_section">
      <div className="bf_wrapper">
        ...
        <p className="bl_sub_head">
          Enter 6 digit code sent to <span className="sent_email">{email}</span>
        </p>
        ...
        <form onSubmit={handleTokenSubmit}>
          ...
          <button
            type="submit"
            className="btn common_button mt-2"
            disabled={isLoading || tokenDigits.some((digit) => !digit)}
          >
  ...
  const renderPasswordStep = () => {
    ...
    return (
      <section className="bl_section">
        <div className="bf_wrapper">
          <img src="./src/images/logo.png" className="k_logo" alt="" />
          <h1 className="bl_head">Reset Your Password</h1>
          <p className="bl_sub_head">Enter your new password below.</p>
  ...
  const renderSuccessStep = () => (
    <section className="bl_section">
      <div className="bf_wrapper">
        <img src="./src/images/logo.png" className="k_logo" alt="" />
        <h1 className="bl_head">Password Changed</h1>
        <p className="bl_sub_head">
          Your password has been successfully reset. Please login with new
          password.
        </p>
