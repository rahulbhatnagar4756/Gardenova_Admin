import type { PageHeaderProps } from "../../types/externalLinks";

/**
 * PageHeader component for external links management page.
 *
 * Renders the heading and an "Add External Link" button.
 *
 * @param props Component props
 * @param props.onAddClick Callback fired when the add button is clicked
 *
 * @returns JSX element for the page header
 */
  ...
  return (
    <div className="main_heading_area">
      <div className="row g-3 align-items-center">
        <div className="col">
          <h4 className="page_heading">Manage External Links</h4>
        </div>
